      ...
      <div className="flex h-full w-full flex-col">
        <div className="flex h-full w-full flex-1 flex-col overflow-y-auto bg-[var(--gray-5)] pb-20">
          ...
          <div className="mx-4 mt-4 flex flex-col gap-3 text-lg text-[var(--gray-90)]">
            <button
              className="flex items-center justify-between rounded-2xl bg-white px-4 py-6 text-lg font-semibold transition hover:bg-gray-50"
          ...
          {/* 회원탈퇴, 로그아웃 버튼 */}
          <div className="mx-4 mt-4 flex flex-col gap-1 text-lg text-[var(--gray-40)]">
            <button
