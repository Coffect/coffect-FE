...
import SuggestPencilImage from "../../assets/icon/home/suggestPencil.png";
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      ...
      <div className="flex w-[305px] flex-col items-center justify-between rounded-[20px] bg-[var(--gray-0)] shadow-[0_0_24px_rgba(28,28,34,0.25)]">
        ...
        {/* 설명 문구 */}
        <p className="mb-[4%] text-center text-sm leading-normal text-[var(--gray-50)]">
          메시지를 함께 적어서 보낼 경우
          <br />
          성사율이 높아져요!
        </p>
        ...
        <textarea
          ...
          placeholder="하고 싶은 이야기나 공통 관심사 등을 어필해보세요! (최대 200자)"
          value={text}
