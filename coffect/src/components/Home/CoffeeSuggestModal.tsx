...
const CoffeeSuggestModal: React.FC<CoffeeSuggestModalProps> = ({
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      {/* 모달 컨테이너 */}
      <div className="flex w-[305px] flex-col items-center justify-between rounded-xl bg-[var(--gray-0)] shadow-[0_0_24px_rgba(28,28,34,0.25)]">
        {/* 상단 콘텐츠 */}
        {/* 제목 */}
        <div className="mt-[6%] mb-[2%] ml-[6%] flex items-center justify-center px-[4%]">
          <h3 className="text-center text-sm font-bold text-[var(--gray-90)]">
            커피챗 제안하기<span className="text-lg">✏️</span>
          </h3>
        </div>

        {/* 설명 문구 */}
        <p className="mb-[6%] text-center text-xs leading-snug text-[var(--gray-50)]">
          메시지를 함께 적어서 보낼 경우
          <br />
          성사율이 높아져요!
        </p>
        ...
        <textarea
          ...
          className="mb-[6%] aspect-[7/6] w-[88%] overflow-hidden rounded-md bg-[var(--gray-5)] p-[4%] text-[0.75rem] leading-tight break-keep focus:border-[var(--gray-40)] focus:ring-1 focus:ring-[var(--gray-40)] focus:outline-none"
        ...
        {/* 버튼 영역(닫기/제안 전송)*/}
        <div className="flex h-[50px] w-full overflow-hidden text-sm">
          {/* 창 닫기 */}
          <button
            onClick={onCancel}
            className="flex-11 rounded-bl-xl border border-[var(--gray-0)] bg-white text-[var(--gray-40)]"
          >
            나중에
          </button>
