    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      ...
      <div className="flex aspect-square w-[305px] flex-col justify-between rounded-xl bg-[var(--gray-0)] shadow-[0_0_24px_rgba(28,28,34,0.25)]">
        ...
        <div className="px-[4%] pt-[10%] pb-[5%] text-center">
          ...
          {/* 설명 문구 */}
          <p className="text-sm leading-relaxed font-semibold whitespace-pre-line text-[var(--gray-40)]">
            답변을 기다리는 동안{"\n"}또 다른 친구에게 보내볼까요?
          </p>
          {/* 이미지 */}
          <img
        ...
        <button
          onClick={onClose}
          className="h-[16.6%] w-full rounded-b-xl bg-[var(--gray-90)] text-base font-semibold text-[var(--gray-0)]"
        >
          알겠어요
        </button>
      </div>
