...
const AlreadyExistIdModal = () => (
  <div className="absolute -top-12 left-1/2 z-50 flex w-max -translate-x-1/2 items-center rounded-2xl bg-[var(--gray-60)] px-4 py-2 text-sm whitespace-nowrap text-white">
