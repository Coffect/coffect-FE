/** 
 * @author : 강신욱
 * @description : 커뮤니티 헤더의 필터 및 정렬 버튼 상태를 관리하는 커스텀 훅입니다. ddd
 * @role : 필터 및 정렬 버튼의 상태를 관리 
 *        - 해당 버튼 클릭 시 상태를 토글하는 로직을 제공합니다.
          - 필터 버튼 클릭 시 필터 모달을 열고 닫는 상태 관리
          - 최신순, 인기순 버튼 클릭 시 각각의 상태를 토글하는 로직
*/
